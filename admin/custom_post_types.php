...
function custom_post_types() {
	...
	$args = array(
		...
		'description'           => __( 'Your product', 'text_domain' ),
		'labels'                => $labels,
	...
	register_post_type( 'custom_product', $args );
        ...
        $labels1 = array(
		'name'                  => _x( 'Devices', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Device', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Devices', 'text_domain' ),
		'name_admin_bar'        => __( 'Devices', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		...
		'filter_items_list'     => __( 'Filter items list', 'text_domain' ),
           ...
           $supports1 = array(
                         "page-attributes","title","editor","thumbnail"
                         );
           
         
	$args1 = array(
		'label'                 => __( 'Device', 'text_domain' ),
		'description'           => __( 'Your device', 'text_domain' ),
		'labels'                => $labels1,
		'supports'              => $supports1,
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => true,
	...
	register_post_type( 'custom_device', $args1 );
